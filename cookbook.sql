...
(1, 'baconCarbonara_9.jpg', 10),
(2, 'cheeseAndPasta_10.jpg', 11);
...
CREATE TABLE recipes (
  ...
  userId SERIAL REFERENCES users NOT NULL,
  recipeName TEXT NOT NULL,
  tags TEXT NOT NULL,
  prepTime TEXT NOT NULL,
  cookTime TEXT NOT NULL,
  mealType SERIAL REFERENCES mealTypes NOT NULL,
...
CREATE TABLE recipeTags (
  tagId SERIAL REFERENCES tags NOT NULL,
  recipeId SERIAL REFERENCES recipes NOT NULL,
